								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
                                    	...
                                    	<div id="log_content" style="margin-top:10px;">
											<textarea cols="63" rows="40" wrap="off" readonly="readonly" id="log_content1" style="width:99%; font-family:'Courier New', Courier, mono; font-size:11px;background:#475A5F;color:#FFFFFF;">
